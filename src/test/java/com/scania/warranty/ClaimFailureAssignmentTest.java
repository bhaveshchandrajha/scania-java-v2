...
class ClaimFailureAssignmentTest {
    ...
    void createFailure_withMandatoryFields_succeeds() {
        ...
        assertThat(errors.get(0).getErrorPart()).isEqualTo("PART123");
        assertThat(errors.get(0).getMainGroup()).isEqualTo("01");
        assertThat(errors.get(0).getSubGroup()).isEqualTo("01");
    }
