...
class ClaimTransmissionTest {
    ...
    private static final String SEED_WORKSHOP = "1A";
    ...
    void postMinimum_whenClaimHasFailureAndStatusMinimum_updatesStatus() {
        Claim claim = claimRepository.findByClaimNumber(SEED_COMPANY, claimNumber).orElseThrow();
        ...
        Claim after = claimRepository.findByClaimNumber(SEED_COMPANY, claimNumber).orElseThrow();
