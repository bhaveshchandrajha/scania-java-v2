...
public class ClaimId implements Serializable {
    ...
    public ClaimId(String pakz, String rechNr, String rechDatum, String auftragsNr, String wete) {
        this.pakz = pakz;
        this.rechNr = rechNr;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(pakz, claimId.pakz) &&
               ...
               Objects.equals(wete, claimId.wete);
    }

    @Override
    public int hashCode() {
        return Objects.hash(pakz, rechNr, rechDatum, auftragsNr, wete);
    }
}