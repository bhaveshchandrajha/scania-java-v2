...
public class Claim {
    ...
    /** Convenience: claim number for API/UI. */
    public String getClaimNumber() {
        return claimNr;
    }

    /** Convenience: company code for API/UI. */
    public String getCompanyCode() {
        return pakz;
    }

    /** Convenience: invoice number for API/UI. */
    public String getInvoiceNumber() {
        return rechNr;
    }

    /** Convenience: invoice date for API/UI. */
    public String getInvoiceDate() {
        return rechDatum;
    }

    /** Convenience: order number for API/UI. */
