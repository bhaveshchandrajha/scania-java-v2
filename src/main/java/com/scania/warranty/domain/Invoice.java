...
public class Invoice {
    ...
    private BigDecimal reserve1; // @rpg-trace: schema

    @Column(name = "RESERVE_2", precision = 9, scale = 2, nullable = false)
    private BigDecimal reserve2; // @rpg-trace: schema
    ...
    private Integer reserve3; // @rpg-trace: schema

    @Column(name = "RESERVE_4", precision = 2, scale = 0, nullable = false)
    private Integer reserve4; // @rpg-trace: schema
    ...
    // Convenience methods for ClaimManagementService
