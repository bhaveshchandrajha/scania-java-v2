...
/**
 * JPA entity for claim errors (HSG73PF).
 */
@Entity
@Table(name = "HSG73PF")
...
public class ClaimError {
    ...
    // Getters and Setters (all 53 fields)
    ...
    public void setAssessmentCode2(Integer assessmentCode2) {
        this.bewCode2 = assessmentCode2;
    }

    public void setAssessmentDate(Integer assessmentDate) {
        this.bewDatum = assessmentDate;
    }

    public void setCompensatedMaterial(Integer compensatedMaterial) {
        this.vergMat = compensatedMaterial;
    }

    public void setCompensatedLabor(Integer compensatedLabor) {
        this.vergArb = compensatedLabor;
    }

    public void setCompensatedSpecial(Integer compensatedSpecial) {
        this.vergSpez = compensatedSpecial;
    }
