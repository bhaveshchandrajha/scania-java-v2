...
public class ClaimCreationService {
    ...
    private final ClaimCreationValidationService validationService;
    ...
    public ClaimCreationService(
            ...
            ClaimCreationValidationService validationService) {
    ...
    public Claim createClaimFromInvoice(String pakz, String invoiceNumber, String invoiceDate, 
        ...
        return createClaimFromInvoice(pakz, invoiceNumber, invoiceDate, orderNumber, area, "1", "04");
    }
    
    public Claim createClaimFromInvoice(String pakz, String invoiceNumber, String invoiceDate, 
                                        String orderNumber, String area, String type, String split) {
        ClaimCreationValidationService.ValidationResult validation = validationService.validateClaimCreation(
                pakz, invoiceNumber, invoiceDate, orderNumber, split, area, type);
        if (!validation.valid()) {
        ...
        Optional<Invoice> invoiceOpt = invoiceRepository.findByPakzAndRnrAndRdatAndAnrAndBereiAndWtAndSplitt(
                pakz, invoiceNumber, invoiceDate, orderNumber, area, type, split);
