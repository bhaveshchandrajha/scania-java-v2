...
The application **defaults to H2 in-memory** so it runs successfully without network access or RDS. This makes the pipeline 100% robust for local development and demos.
